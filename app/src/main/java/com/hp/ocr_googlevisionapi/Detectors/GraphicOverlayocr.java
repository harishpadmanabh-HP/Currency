 ...
 */
package com.hp.ocr_googlevisionapi.Detectors;
 ...
 * </ol>
 */
public class GraphicOverlayocr<T extends GraphicOverlayocr.Graphic> extends View {
     ...
     * graphics element.  Add instances to the overlay using {@link GraphicOverlayocr#add(Graphic)}.
     */
    public static abstract class Graphic {
        private GraphicOverlayocr mOverlay;

        public Graphic(GraphicOverlayocr overlay) {
            mOverlay = overlay;
        }
    ...
    public GraphicOverlayocr(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
